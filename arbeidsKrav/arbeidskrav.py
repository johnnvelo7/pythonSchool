...
def Quiz():
    ...
    print(f"Quiz completed! You answered {num_correct_answers} questions correctly and {num_wrong_answers} questions incorrectly.\n")
    # Print wrong answers with correct answers
